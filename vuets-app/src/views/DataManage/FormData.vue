<template>
    <div class="form-data">
        ...
        <span slot="footer" class="dialog-footer">
            <el-button size="small" @click="submitForm('ruleForm')" type="primary">创建课程</el-button>
...
export default class FormData extends Vue {
    ...
    @Provide() rules: any = {
        ...
        level: [
            { required: true, message: '请选择课程等级', tigger: 'change' }
        ],
        count: [{ required: true, message: '请选择报名人数', trigger: 'blur' }],
        date: [
            {
                type: 'string',
                required: true,
